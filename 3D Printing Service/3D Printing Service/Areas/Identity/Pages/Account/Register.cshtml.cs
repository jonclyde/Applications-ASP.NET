        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.PrinterUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.PrinterUser));
                    }

                    if(role==SD.PrinterUser)
                    {
                        await _userManager.AddToRoleAsync(user, SD.PrinterUser);
                    }
                    else
                    {
