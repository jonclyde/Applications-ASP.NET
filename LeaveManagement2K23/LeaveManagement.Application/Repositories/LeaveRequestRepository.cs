...
namespace LeaveManagement.Application.Repositories
{
    public class LeaveRequestRepository : GenericRepository<LeaveRequest>, ILeaveRequestRepository
    {
        ...
        public LeaveRequestRepository(ApplicationDbContext context, IMapper mapper, ILeaveAllocationRepository leaveAllocationRepository, AutoMapper.IConfigurationProvider configurationProvider, IEmailSender emailSender, IHttpContextAccessor httpContextAccessor, UserManager<Employee> userManager) : base(context)
        {
        ...
        public async Task CancelLeaveRequest(int leaveRequestId)
        {
            ...
            await emailSender.SendEmailAsync(user.Email, $"Leave Request is Cancelled", $"Your leave request from {leaveRequest.StartDate} to {leaveRequest.EndDate} has been cancelled");
        }
        ...
        public async Task ChangeApprovalStatus(int Id, bool approved)
        {
            ...
            await emailSender.SendEmailAsync(user.Email, $"Leave Request is {approvalStatus}", $"You leave request from {leaveRequest.StartDate} to {leaveRequest.EndDate} has been {approvalStatus}");
        }
        ...
        public async Task<bool> CreateLeaveRequest(LeaveRequestCreateVM model)
        {
            ...
            await emailSender.SendEmailAsync(user.Email, "Leave Request Created", "Your leave request has been successfully created.");
