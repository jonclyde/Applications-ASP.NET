    ...
    public class LeaveAllocationRepository : GenericRepository<LeaveAllocation>, ILeaveAllocationRepository
    {
        ...
        public async Task LeaveAllocation(int leaveTypeId)
        {
            ...
            foreach (var employee in employeesWithNewAllocations)
            {
                ...
                //Email user with details of their new leave allocation
                await emailSender.SendEmailAsync(employee.Email, "Leave Allocation", $"You have been allocated {leaveType.DefaultDays} days of {leaveType.Name} leave for the year {period}");
            }
